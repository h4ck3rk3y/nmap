...
action = function(host, port)
  ...
  local invasive = stdnse.get_script_args(SCRIPT_NAME..".invasive") or nil
  local path_table
  if invasive then
     path_table = {"/cgi-sys/entropysearch.cgi","/cgi-sys/defaultwebpage.cgi",
    "/cgi-mod/index.cgi","/cgi-bin/test.cgi","/cgi-bin-sdb/printenv", uri}
  else
     path_table = {uri}
  end   
  local rnd = nil
